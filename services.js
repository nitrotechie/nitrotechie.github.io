...
function viewDetails(i) {
    getImage(vehicles[i].manufacturer_model, i);
    var disp = "";
    var obj = vehicles[i];
...
function getImage(str, i) {
    str = str.replaceAll(' ', '+');
    fetch('https://www.googleapis.com/customsearch/v1?key=AIzaSyDhZJJEBxFlF3Un3XNgrU8jLIsG9r5K_A8&cx=331a4f848f08e4593&q=' + str + '')
    ...
    //         image = res.items[0].pagemap.cse_image[0].src;
    //         viewDetails(i);
    //     }
    // });

    // xhr.open("GET", "https://www.googleapis.com/customsearch/v1?key=AIzaSyDhZJJEBxFlF3Un3XNgrU8jLIsG9r5K_A8&cx=331a4f848f08e4593&q="+str+"");
    // xhr.send();
}
// function getImage(str, i) {
...
//             var res = JSON.parse(this.responseText);
//             console.log(res);
//             image = res.response.images[0].image.url;
//             viewDetails(i);
//         }
//     });

//     xhr.open("GET", "https://joj-image-search.p.rapidapi.com/v2/?q="+str+"&hl=en");
//     xhr.setRequestHeader("X-RapidAPI-Key", "34d7586602mshf925db23b250065p1b31dcjsn92c1d836df0c");
//     xhr.setRequestHeader("X-RapidAPI-Host", "joj-image-search.p.rapidapi.com");
